...
ActiveRecord::Schema[7.0].define(version: 2024_09_19_102428) do
  ...
  create_table "checklist_template_descriptions", force: :cascade do |t|
    t.string "description"
    t.bigint "checklist_template_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["checklist_template_id"], name: "index_checklist_template_descriptions_on_checklist_template_id"
  end
  ...
  create_table "checklist_templates", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "tourman_id"
    t.index ["tourman_id"], name: "index_checklist_templates_on_tourman_id"
  end
  ...
  create_table "checklists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["concert_id"], name: "index_checklists_on_concert_id"
  end
  ...
  create_table "concert_templates", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "data"
    t.string "name"
  ...
  create_table "guest_lists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["concert_id"], name: "index_guest_lists_on_concert_id"
  end
  ...
  create_table "notes", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "description"
    t.index ["concert_id"], name: "index_notes_on_concert_id"
  end
  ...
  add_foreign_key "checklist_template_descriptions", "checklist_templates"
  add_foreign_key "checklist_templates", "tourmen"
  add_foreign_key "checklists", "concerts"
  ...
  add_foreign_key "notes", "concerts"
